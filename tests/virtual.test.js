...
describe('virtual', function () {
	...
	describe('atomic()', function () {
		...
		it('at-rules', function () {
			...
			nano.atomic('color:red;', null, '@media screen')
		...
		it('caches at-rules', function () {
			...
			const className = nano.atomic('color:red;', null, '@media screen')

			const cachedClassName = nano.atomic('color:red;', null, '@media screen')
